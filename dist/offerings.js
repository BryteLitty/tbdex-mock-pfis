...
export const offeringDataTBDollarsToUSDC = {
...
export const offeringDataUSDToGHS = {
...
export const offeringDataUSDToKES = {
...
export const offeringDataKESToZAR = {
...
export const offeringDataGHSToUSDC = {
...
export const offeringDataUSDToNGN = {
...
export const offeringDataZARToBTC = {
...
export const offeringDataEURToZAR = {
...
export const offeringDataGBPToCAD = {
...
export const offeringDataUSDToGBP = {
    description: `Exchange your US Dollars for British Pounds`,
    payoutUnitsPerPayinUnit: '0.82',
    payout: {
        currencyCode: 'GBP',
        methods: [
            {
...
export const offeringDataAUDToJPY = {
...
export const offeringDataZARToNGN = {
...
export const offeringDataGHSToKES = {
...
export const offeringDataMADToEGP = {
...
export const offeringDataGHSToNGN = {
    description: `Exchange your Ghanaian Cedis for Nigerian Naira`,
    payoutUnitsPerPayinUnit: '75.5',
    payout: {
        currencyCode: 'NGN',
        methods: [
            {
...
async function createRandomOffering(index) {
    ...
    const offering = Offering.create({
        metadata: {
            from: config.pfiDid[customPFIIndex].uri,
            protocol: '1.0'
        },
...
const hardcodedOfferings = await Promise.all(Array.from({ length: 10 }, (_, i) => createRandomOffering(i)));
export class HardcodedOfferingRepository {
    pfi;
    pfiHardcodedOfferings;
    constructor(pfi) {
        this.pfi = pfi;
