...
export class VerifiableCredential {
    ...
    sign(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const vcJwt = yield Jwt.sign({
                ...
                payload: Object.assign({ vc: this.vcDataModel, nbf: Math.floor(new Date(this.vcDataModel.issuanceDate).getTime() / 1000), jti: this.vcDataModel.id, iss: options.did.uri, sub: this.subject, iat: Math.floor(Date.now() / 1000) }, (this.vcDataModel.expirationDate && {
    ...
    static create(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const vcDataModel = Object.assign(Object.assign(Object.assign({ '@context': [DEFAULT_VC_CONTEXT], type: Array.isArray(type)
                    ? [DEFAULT_VC_TYPE, ...type]
                    : (type ? [DEFAULT_VC_TYPE, type] : [DEFAULT_VC_TYPE]), id: `urn:uuid:${cryptoUtils.randomUuid()}`, issuer: issuer, issuanceDate: issuanceDate || getCurrentXmlSchema112Timestamp(), credentialSubject: credentialSubject }, (expirationDate && { expirationDate })), (credentialSchema && { credentialSchema })), (evidence && { evidence }));
